...
const G = () => (
  <style>{`
    ...
    *{-webkit-tap-highlight-color:transparent}
    ...
    .fit-quote{font-family:'Playfair Display',serif;font-style:italic;font-size:14.5px;line-height:1.7;color:var(--ink3);margin-bottom:14px;padding:14px 16px;border-radius:12px;background:var(--surface);border:1px solid var(--border2);text-align:left}
